...
from edgeimpulse_api.models.get_deployment_history_response import GetDeploymentHistoryResponse
...
from edgeimpulse_api.models.list_deployment_history_response import ListDeploymentHistoryResponse
...
class DeploymentApi(object):
    ...
    @validate_arguments
    def download_historic_deployment(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], deployment_version : Annotated[StrictInt, Field(..., description="Deployment version ID")], **kwargs) -> str:  # noqa: E501
        ...
        :param project_id: Project ID (required)
        :type project_id: int
        :param deployment_version: Deployment version ID (required)
        :type deployment_version: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._download_historic_deployment_with_http_info(project_id, deployment_version, **kwargs)  # noqa: E501

    @validate_arguments
    def _download_historic_deployment_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], deployment_version : Annotated[StrictInt, Field(..., description="Deployment version ID")], **kwargs):  # noqa: E501
        """Download historic deployment
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method download_historic_deployment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        if _params['project_id']:
            _path_params['projectId'] = _params['project_id']
        if _params['deployment_version']:
            _path_params['deploymentVersion'] = _params['deployment_version']
        ...
        return self.api_client.call_api(
            '/api/{projectId}/deployment/history/{deploymentVersion}/download', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def get_historic_deployment(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], deployment_version : Annotated[StrictInt, Field(..., description="Deployment version ID")], **kwargs) -> GetDeploymentHistoryResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: GetDeploymentHistoryResponse
        """
        kwargs['_return_http_data_only'] = True
        return self._get_historic_deployment_with_http_info(project_id, deployment_version, **kwargs)  # noqa: E501

    @validate_arguments
    def _get_historic_deployment_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], deployment_version : Annotated[StrictInt, Field(..., description="Deployment version ID")], **kwargs):  # noqa: E501
        """Get historic deployment
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(GetDeploymentHistoryResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_historic_deployment" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "GetDeploymentHistoryResponse",
        }

        return self.api_client.call_api(
            '/api/{projectId}/deployment/history/{deploymentVersion}', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def list_deployment_history(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], impulse_id : Annotated[Optional[StrictInt], Field(description="Impulse ID. If this is unset, data for all impulses is returned.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Maximum number of results")] = None, offset : Annotated[Optional[StrictInt], Field(description="Offset in results, can be used in conjunction with LimitResultsParameter to implement paging.")] = None, **kwargs) -> ListDeploymentHistoryResponse:  # noqa: E501
        ...
        :param project_id: Project ID (required)
        :type project_id: int
        :param impulse_id: Impulse ID. If this is unset, data for all impulses is returned.
        :type impulse_id: int
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ListDeploymentHistoryResponse
        """
        kwargs['_return_http_data_only'] = True
        return self._list_deployment_history_with_http_info(project_id, impulse_id, limit, offset, **kwargs)  # noqa: E501

    @validate_arguments
    def _list_deployment_history_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], impulse_id : Annotated[Optional[StrictInt], Field(description="Impulse ID. If this is unset, data for all impulses is returned.")] = None, limit : Annotated[Optional[StrictInt], Field(description="Maximum number of results")] = None, offset : Annotated[Optional[StrictInt], Field(description="Offset in results, can be used in conjunction with LimitResultsParameter to implement paging.")] = None, **kwargs):  # noqa: E501
        """List deployment history
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ListDeploymentHistoryResponse, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_deployment_history" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        _response_types_map = {
            '200': "ListDeploymentHistoryResponse",
        }

        return self.api_client.call_api(
            '/api/{projectId}/deployment/history', 'GET',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
