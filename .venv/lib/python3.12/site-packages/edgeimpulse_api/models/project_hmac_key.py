...
class ProjectHmacKey(BaseModel):
    id: StrictInt = ...
    ...
    __properties = ["id", "hmacKey", "isDevelopmentKey", "name", "created", "createdByUser"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectHmacKey:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectHmacKey:
        """Create an instance of ProjectHmacKey from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProjectHmacKey.construct(**obj)

        _obj = ProjectHmacKey.construct(**{
            "id": obj.get("id"),
